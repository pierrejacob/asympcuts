...
RcppExport SEXP _asympcuts_rmvnorm(SEXP nsamplesSEXP, SEXP meanSEXP, SEXP covarianceSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _asympcuts_dmvnorm(SEXP xSEXP, SEXP meanSEXP, SEXP covarianceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_asympcuts_rmvnorm", (DL_FUNC) &_asympcuts_rmvnorm, 3},
    {"_asympcuts_dmvnorm", (DL_FUNC) &_asympcuts_dmvnorm, 3},
    {"_rcpp_module_boot_module_mvnorm", (DL_FUNC) &_rcpp_module_boot_module_mvnorm, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_asympcuts(DllInfo *dll) {
